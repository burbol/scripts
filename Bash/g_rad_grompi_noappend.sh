...
for i in 25 41 # OH density of the SAM 
...
do
  ...
  cd /net/data/eixeres/NewVersion4/FINISHED/s${i}_w${j}/part0002
  #cd s${i}_w${j}
...
#######################################################################
 ...
 #uncomment! echo "0" "q"|make_ndx -f sam${i}_water${j}.part002.gro -o index${i}_${j}.ndx 
 
   /net/data/eixeres/sheldon-old/gromacs_tpi_compiled/bin/grompp -f NVT.mdp -c NVT_sam${i}_water${j}.part002.gro -p ${i}pc_${j}.top -n index${i}_${j}.ndx -o g_rad_NVT_sam${i}_water${j}.part002.tpr -maxwarn 1
    
    echo ${n} | g_density -f NVT_sam${i}_water${j}.part002.xtc -s g_rad_NVT_sam${i}_water${j}.part002.tpr -o g_density_NVT_sam${i}_water${j}.part002.xvg -sl 1000
    echo "6" | g_density -f NVT_sam${i}_water${j}.part002.xtc -s g_rad_NVT_sam${i}_water${j}.part002.tpr -o g_density_SAM_sam${i}_water${j}.part002.xvg -sl 1000 # for SAMs density maps
    ...
    #grompp -f NVT.mdp -c NVT_sam${i}_water${j}.gro -p ${i}pc_${j}.top -n index${i}_${j}.ndx -o g_rad_NVT_sam${i}_water${j}.tpr -maxwarn 1
     echo ${n} | g_density -dens number -f NVT_sam${i}_water${j}.part002.xtc -s g_rad_NVT_sam${i}_water${j}.part002.tpr -o ng_density_NVT_sam${i}_water${j}.part002.xvg -sl 1000
    #cp    ng_density_NVT_sam${i}_water${j}.xvg /home/eixeres/Dropbox/Apps/Computable/December/StepByStepDropletMethod/
    
      echo "5" |g_density -dens number -f NVT_sam${i}_water${j}.part002.xtc -s g_rad_NVT_sam${i}_water${j}.part002.tpr -o ng_density_SAM_sam${i}_water${j}.part002.xvg -sl 1000
...
#rm g_density_NVT_sam${i}_water${j}.xvg	
    ...
    do    
        ...
        echo ${n} ${n} | /net/data/eixeres/sheldon-old/g_rad_density -f NVT_sam${i}_water${j}.part002.xtc -s g_rad_NVT_sam${i}_water${j}.part002.tpr -n index${i}_${j}.part002.ndx -sz 200 -o g_rad_dmap_${i}pc_w${j}_${nanosecs1}ns_${nanosecs2}ns.xvg -b ${start} -e ${ending}
