...
myfile = open('Contact_Angles_p2_BIG.txt', 'w')
myfile2 = open('Contact_Angles2_p2_BIG.txt', 'w')
...
pp = PdfPages('/home/eixeres/Downloads/g_rad_densmaps_p2/Circle_plots_p2_BIG.pdf')
...
peakcount = 0
for b in [0, 5, 17]:
    for c in [5000, 6500, 7000, 8000, 9000, 10000]:
    #for c in [4000]: 
#        os.chdir('/home/eixeres/Downloads/Berendsen')
