...
os.chdir("/media/My Book/backup_eixeres/Downloads/g_rad_densmaps_p2")
...
myfile = open('Contact_Angles_p2_s11.txt', 'w')
myfile2 = open('Contact_Angles2_p2_s11.txt', 'w')
...
pp = PdfPages('/media/My Book/backup_eixeres/Downloads/g_rad_densmaps_p2/Circle_plots_p2_s11.pdf')
