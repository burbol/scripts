...
myfile = open('Contact_Angles_next_s5.txt', 'w')
myfile2 = open('Contact_Angles2_next_s5.txt', 'w')
...
#pp = PdfPages('/media/BERT/Downloads/g_rad_densmaps_p3/Circle_plots_next.pdf')
pp = PdfPages('Circle_plots_next_s5.pdf')
...
#		os.chdir(foldername)
		print 'Starting to analize s',str(b),'w', str(c)
		print >> myfile, '			 '
