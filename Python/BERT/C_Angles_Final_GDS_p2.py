...
myfile = open('Contact_Angles_p2.txt', 'w')
myfile2 = open('Contact_Angles2_p2.txt', 'w')
...
pp = PdfPages('/media/My Book/backup_eixeres/Downloads/g_rad_densmaps_p2/Circle_plots_p2.pdf')
