...
os.chdir("/Volumes/BERT/Downloads/g_rad_densmaps_s11_repeated")
...
myfile = open('Contact_Angles_s11_repeated.txt', 'w')
myfile2 = open('Contact_Angles2_s11_repeated.txt', 'w')
...
pp = PdfPages('/Volumes/BERT/Downloads/g_rad_densmaps_s11_repeated/Circle_plots_s11_repeated.pdf')
