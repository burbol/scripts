...
ZLENGTH = 12.0 # *(for "older" systems use ZLENGTH =12.0, for new BIG systems ZLENGTH=20.0)
start_time=0
end_time=100

# Main directory where all the density files are stored, and where the results will be stored too
#densfolder="/Users/burbol/Downloads/g_rad_densmaps_s33s50"
#densfolder="/media/SHELDON/files_for_laila/g_rad_densmaps_all"

#densfolder="/Volumes/UNI/SHELDON/files_for_laila/s0_w1000"

#densfolder="/Volumes/UNI/SHELDON/CLOSEDsheldon/eixeres/files_for_laila/s33_sheldon-ng/s33_w5000"
densfolder="/media/SHELDON/s11_w2000_dmap2"
#densfolder="/Volumes/UNI/SHELDON/files_for_laila/g_rad_densmaps_all"
#densfolder="/Volumes/UNI/SHELDON/CLOSEDsheldon/eixeres/files_for_laila/g_rad_densmaps_s11_repeated/"
#densfolder="/Volumes/UNI/SHELDON/g_rad_densmaps_s33s50"


#File with the positions of z=0
#peaksinput='MiddlePoint.txt' #z=0 is the middle point between the first water peak  and the last SAM peak of each system
#peaksinput='/home/eixeres/Dropbox/Apps/Computable/Definitions_Interface/All_systems_without66/SAMPeaks.txt' #z=0 is the last SAM peak of each system
#peaksinput='/home/eixeres/Dropbox/Apps/Computable/Definitions_Interface/All_systems_without66/MiddlePoint.txt' #z=0 is the first water peak of each system
peaksinput='/home/eixeres/Dropbox/Apps/Computable/Definitions_Interface/All_systems_without66/GDS_positions_CORRECTED.txt'
#peaksinput='/Users/burbol2/Dropbox/Apps/Computable/Definitions_Interface/All_systems_without66/WaterPeaksFinal.txt'
...
#txtoutput='Contact_Angles_SAMPeak_s'+str(SAMs[0])+'.txt'
#txtoutput2='Contact_Angles2_SAMPeak_s'+str(SAMs[0])+'.txt'
...
#plotsOutput='MiddlePeakCircle_plots_all_s'+str(SAMs[0])+'.pdf'
#plotsOutput='SAMPeakCircle_plots_all_s'+str(SAMs[0])+'.pdf'
#plotsOutput='WaterPeakCircle_plots_all_s'+str(SAMs[0])+'.pdf' # in "older" systems the name starts with "Circle_plots_all_"
#plotsOutput='GDSCircle_plots_all_s'+str(SAMs[0])+'.pdf'

#Output for single systems:
txtoutput='Contact_Angles_GDS_s'+str(SAMs[0])+'_w'+str(Waters[0])+'.txt'
txtoutput2='Contact_Angles2_GDS_s'+str(SAMs[0])+'_w'+str(Waters[0])+'.txt'
plotsOutput='GDSCircle_plots_all_s'+str(SAMs[0])+'_w'+str(Waters[0])+'.pdf'
...
# The functions calc_R and f_3 will be used in the function from_slice_circle
	...
	# x, y are the coordinates of the point; xc, yc are the coordinates of the circle center; R is its radius.
	 ...
	 # We look for the first and last fitted LG-interface points (related to the first and last droplet slices: slicemin and slicemax) with a distance to the circle smaller then epsilon, which we set to 0.029nm.
				...
				epsilon2 = 0.031
	# For slicemin
				if from_slice_circle(slicemax, slicemin, input, zcoord)==None:
					print >> myfile, '{0}  {1}  {2}'.format(filename, 'nan', 'nan')
					print >> myfile2, '{0}  {1}'.format('nan', 'nan')
					continue 
