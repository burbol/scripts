...
os.chdir("/media/SHELDON/g_rad_densmaps_next")
...
#peak = np.loadtxt('SAMPeaks.txt', skiprows=1)
peak = np.loadtxt('MiddlePoint.txt', skiprows=1)
...
for b in [0, 5, 11, 17]:
    ...
    myfile = open('/home/eixeres/Downloads/MiddlePeakContact_Angles_next_s'+str(b)+'.txt', 'w')
    myfile2 = open('/home/eixeres/Downloads/MiddlePeakContact_Angles2_next_s'+str(b)+'.txt', 'w')
    for c in [1000, 2000, 3000, 4000, 5000, 6500, 7000, 8000, 9000, 10000]:
    #for c in [1000]:  # FOR TESTING!!!!
        ...
        pp = PdfPages('/home/eixeres/Downloads/MiddlePeakCircle_plots_next_s'+str(b)+'.pdf')
        ...
        #for d in frange(0, 10, 0.5):   # FOR TESTING!!!!
            l = d + 0.5
            l = str(l)
            d = str(d)
            xvg = XVG()
