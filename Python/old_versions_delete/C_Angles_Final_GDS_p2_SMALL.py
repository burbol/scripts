...
myfile = open('Contact_Angles_p2_SMALL.txt', 'w')
myfile2 = open('Contact_Angles2_p2_SMALL.txt', 'w')
...
pp = PdfPages('/home/eixeres/Downloads/g_rad_densmaps_p2/Circle_plots_p2_SMALL.pdf')
