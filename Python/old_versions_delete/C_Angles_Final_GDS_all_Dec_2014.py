...
#densfolder="/Volumes/UNI/SHELDON/CLOSEDsheldon/eixeres/files_for_laila/g_rad_densmaps_all"
#densfolder="/Volumes/UNI/SHELDON/CLOSEDsheldon/eixeres/files_for_laila/s0_w3000_merged/"
#densfolder="/Volumes/UNI/SHELDON/CLOSEDsheldon/eixeres/files_for_laila/g_rad_densmaps_next"
#densfolder="/Volumes/UNI/SHELDON/g_rad_densmaps_s33s50"


#File with the positions of z=0
#peaksinput='/Users/burbol2/Dropbox/Apps/Computable/Definitions_Interface/All_systems_without66/MiddlePoint.txt' #z=0 is the middle point between the first water peak  and the last SAM peak of each system
#peaksinput='/Users/burbol2/Dropbox/Apps/Computable/Definitions_Interface/All_systems_without66/SAMPeaks.txt' #z=0 is the last SAM peak of each system
#peaksinput='/Users/burbol2/Dropbox/Apps/Computable/Definitions_Interface/All_systems_without66/WaterPeaksFinal.txt' #z=0 is the first water peak of each system
...
#txtoutput2='Contact_Angles2_WaterPeak_s'+str(SAMs[0])+'_next.txt'
#txtoutput='Contact_Angles_WaterPeak_s'+str(SAMs[0])+'_next.txt'
...
#plotsOutput='WaterPeakCircle_plots_all_s'+str(SAMs[0])+'_next.pdf' # in "older" systems the name starts with "Circle_plots_all_"
