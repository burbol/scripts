...
os.chdir("/home/eixeres/Downloads/g_rad_densmaps_p2")

#Read file with positions of the first water peaks and save in variable "peaks"
...
myfile = open('Contact_Angles_s11_p2_BIG.txt', 'w')
myfile2 = open('Contact_Angles2_s11__p2__BIG.txt', 'w')
...
pp = PdfPages('/home/eixeres/Downloads/g_rad_densmaps_p2/Circle_plots_s11_p2_BIG.pdf')
