...
os.chdir("/Users/burbol/Downloads/TEST")
...
myfile = open('Contact_Angles_p2_TEST.txt', 'w')
myfile2 = open('Contact_Angles2_p2_TEST.txt', 'w')
...
pp = PdfPages('/Users/burbol/Downloads/TEST/Circle_plots_p2_TEST.pdf')
...
# We use the function waterbulk, and set the variable "bulk" as the returned value.
...
# "maxfev" is the allowed number of function calls when doing the fit. The default number was 800.
