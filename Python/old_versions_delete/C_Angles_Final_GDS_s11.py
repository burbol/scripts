...
os.chdir("/home/eixeres/Downloads/g_rad_densmaps")
...
myfile = open('Contact_Angles_s11.txt', 'w')
myfile2 = open('Contact_Angles2_s11.txt', 'w')
...
pp = PdfPages('/home/eixeres/Downloads/g_rad_densmaps/Circle_plots_s11.pdf')
...
peakcount = 0
for b in [11]:
    for c in [1000, 2000, 3000, 4000, 5000, 7000, 8000, 10000]:
    #for c in [4000]: 
#        os.chdir('/home/eixeres/Downloads/Berendsen')
