...
# systems to analise
SAMs=[33]
Waters=[1000, 7000, 8000, 9000, 10000]


# ZLENGTH is the system total length in the z-direction Change this value if necessary.
ZLENGTH = 20.0 # *(for "older" systems use ZLENGTH =12.0, for new BIG systems ZLENGTH=20.0)
start_time=0
end_time=100
...
#peaksinput='SAMPeaks.txt' #z=0 is the last SAM peak of each system
peaksinput='WaterPeaksFinal.txt' #z=0 is the first water peak of each system
...
txtoutput='Contact_Angles_WaterPeak_Last_s33.txt'
txtoutput2='Contact_Angles2_WaterPeak_Last_s33.txt'
...
plotsOutput='WaterPeakCircle_plots_Last_s33.pdf'
