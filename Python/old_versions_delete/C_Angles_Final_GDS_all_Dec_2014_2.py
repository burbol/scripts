...
txtoutput='Contact_Angles_WaterPeak_s'+str(SAMs[0])+'_w'+str(Waters[0])+'.txt'
txtoutput2='Contact_Angles2_WaterPeak_s'+str(SAMs[0])+'_w'+str(Waters[0])+'.txt'
plotsOutput='WaterPeakCircle_plots_all_s'+str(SAMs[0])+'_w'+str(Waters[0])+'.pdf'
