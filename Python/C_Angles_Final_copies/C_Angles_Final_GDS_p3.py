...
myfile = open('Contact_Angles_all.txt', 'w')
myfile2 = open('Contact_Angles2_all.txt', 'w')
...
pp = PdfPages('/media/SHELDON/files_for_laila/g_rad_densmaps_all/Circle_plots_p3.pdf')
...
peakcount = 0
for b in [0, 5, 11, 17]:
    for c in [1000, 2000, 3000, 4000, 6500, 7000, 8000, 9000, 10000]:
    #for c in [4000]: 
