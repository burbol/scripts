...
os.chdir("/home/eixeres/files_for_laila/g_densmaps_p4")
...
myfile = open('Contact_Angles_TEST.txt', 'w')
myfile2 = open('Contact_Angles2_TEST.txt', 'w')
...
pp = PdfPages('/home/eixeres/files_for_laila/g_densmaps_p4/Circle_plots_TEST.pdf')
