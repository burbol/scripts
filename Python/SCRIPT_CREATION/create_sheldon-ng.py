...
N = 3  # NUMBER OF SCRIPTS TO SUBMIT
...
Simns = {1000:60, 2000:60, 3000:60, 4000:60, 5000:60, 6500:60, 7000:60, 8000:60, 9000:60, 10000:60}  # total simulation time length in ns
Nodes = {1000:3, 2000:3, 3000:3, 4000:3, 5000:3, 6500:3, 7000:5, 8000:6, 9000:6, 10000:6} 
...
for i in pc:
	for j in molec:
		...
		Dir = '/Users/burbol2/Dropbox/scripts/Python/SCRIPT_CREATION/SLURM/s'+str(i)+'_w'+str(j)
		...
		for k in range(N):
			...
			#JobOut.write('#SBATCH --mem-per-cpu=' + str(Memory) +'\n')
			...
			if k == 0:			
				...
				JobOut.write('mpirun -np ' + str(CpuNum) + ' mdrun -deffnm ' + Minifile + ' -maxh ' + str(SimTime) + ' -v -testverlet\n')				
